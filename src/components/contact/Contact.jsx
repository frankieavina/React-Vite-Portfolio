            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <a href="https://www.linkedin.com/in/frankieavina/" className="contact_button">
                            Write me{''}
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">m3frankieavina@gmail.com</span>

                        <a href="mailto:m3frankieavina@gmail.com.com" className="contact_button">
                            Write me{''}
                            <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                        </a>
                    </div>   
