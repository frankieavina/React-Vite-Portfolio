...
const Data = () => {
  return (
    <div className="home_data">
        ...
        <p className="home_description">Hi my name is Francisco Avina and I am a developer of the web enthusiastic about crafting seamless and engaging online experiences.
        </p>
